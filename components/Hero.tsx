...
const Hero = () => {
  ...
  return (
    <div className="h-[100vh] flex flex-col justify-center items-center ">
      ...
      <div onClick={setFoces} className="flex justify-between  rounded-3xl overflow-hidden items-center px-10 py-1 cursor-pointer mt-24 bg-[#FFFFFFA6] w-[70%] h-20" id="search">
